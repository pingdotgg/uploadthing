...
The `@uploadthing/react` package provides a set of premade React components that
you can use to upload files to your server. It also provides a set of hooks that
you can use to build your own custom components.

## Creating The UploadThing Components (recommended)

While you can import the components directly from `@uploadthing/react`, we
