...
| input                  | string   | If set on the fileroute | Object matching the input schema that was set for this endpoint in your File Router |
...
| onUploadProgress       | function | No                      | callback function for upload progress                                               |
...
| :--------------------- | :------- | :-------------------------------------------------------------------------------- |
| onClientUploadComplete | function | `{fileKey: string, fileUrl: string}[]` callback function when upload is completed |
| onUploadError          | function | callback function when upload fails                                               |
| onUploadProgress       | function | callback function for upload progress                                             |
