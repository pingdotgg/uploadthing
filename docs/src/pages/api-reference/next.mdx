...
programmatically set your UploadThing credentials. If you do not specify a `config`
we will use the `UPLOADTHING_SECRET` and `UPLOADTHING_APP_ID` environment variables. 
