...
`uploadFiles` let's you upload files without needing to define file routes. This
can be useful for uploading files from sever actions, or your own API routes.
