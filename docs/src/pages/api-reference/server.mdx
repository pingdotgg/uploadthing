...
You can also tag your metadata using the `UTFiles` symbol to override the
uploaded files attributes. This can be used to either rename the file, or set a
custom identifer for the file:
