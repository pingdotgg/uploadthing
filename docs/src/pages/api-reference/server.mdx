...
are used, your files are uploaded via our servers.
...
`uploadFilesFromUrl` is similar to `uploadFiles` as it let's you upload files
...
before being uploaded via our servers.
