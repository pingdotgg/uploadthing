...
| Arguments (Overload 1) | Type                     | Required | Description                                                            |
| :--------------------- | :----------------------- | :------- | :--------------------------------------------------------------------- |
| updates                | ACLUpdate \| ACLUpdate[] | Yes      | Objects of what file keys or customIds as well as the ACL to update to |

| Arguments (Overload 2) | Type                       | Required | Description                                                                            |
| :--------------------- | :------------------------- | :------- | :------------------------------------------------------------------------------------- |
| keys                   | string[]                   | Yes      | The file key you want to get the URL for.                                              |
| acl                    | "public-read" \| "private" | Yes      | How long the URL should be valid for. Must be positive and less than 604 800 (7 days). |
| opts.keyType           | "fileKey" \| "customId"    | No       | The type of key you are passing in. Defaults to `fileKey`                              |

#### `ACLUpdate` type definition
