...
- disable this setting in your Vercel project (Settings > Deployment Protection > Vercel Authentication)
— or if you are paying for Advanced Deployment Protection—set a
