...
Make sure that `/api/uploadthing` is PUBLICLY EXPOSED through your middleware. It serves as both a validation endpoint from client AND a webhook for the `onUploadComplete` calls.
