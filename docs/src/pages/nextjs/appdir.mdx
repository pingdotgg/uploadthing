...
To do this, simply render the `<NextSSRPlugin />` hydration helper in the body
of your root layout **before** the children. The before and after is shown below
(refresh page to see the difference):
