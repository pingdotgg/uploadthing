...
<Callout type="info">
  ...
  [here](https://github.com/pingdotgg/uploadthing/tree/main/examples/minimal-nuxt)
</Callout>
<Callout type="info">
  Using standalone Vue without Nuxt? Checkout the standalone example
  [here](https://github.com/pingdotgg/uploadthing/tree/main/examples/backend-adapters/client-vue)
</Callout>
