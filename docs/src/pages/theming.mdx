...
<UploadButton
  __internal_ut_disabled
  __internal_state="ready"
  className="ut-button:bg-red-500 ut-button:ut-readying:bg-red-500/50 mt-6"
  content={{
...
<UploadDropzone
  ...
  className="ut-label:text-lg ut-allowed-content:ut-uploading:text-red-300 mt-6 bg-slate-800"
  content={{
    allowedContent: "Allowed content",
    button: "Ready",
  }}
...
<UploadButton
  ...
  appearance={{
    button:
      "ut-ready:bg-green-500 ut-uploading:cursor-not-allowed rounded-r-none bg-red-500 bg-none after:bg-orange-400",
    container:
      "mx-auto w-max flex-row rounded-md border-cyan-300 bg-slate-800 mt-2",
    allowedContent: "flex h-8 flex-col items-center justify-center px-2",
  }}
  content={{
    allowedContent: "Allowed content",
