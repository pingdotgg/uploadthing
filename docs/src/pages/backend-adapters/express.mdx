...
- [NextJS App directory](/getting-started/appdir#creating-the-uploadthing-components-optional)
- [NextJS Pages directory](/getting-started/pagedir#creating-the-uploadthing-components-optional)
