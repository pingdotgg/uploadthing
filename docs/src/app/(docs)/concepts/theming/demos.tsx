...
export const TWClassName1 = () => (
  <UploadButton
    endpoint="mockRoute"
    className="mt-4 ut-button:bg-red-500 ut-button:ut-readying:bg-red-500/50 dark:ut-allowed-content:text-white"
    content={{
...
export const TWClassName3 = () => (
  <UploadDropzone
    endpoint="mockRoute"
    className="mt-4 bg-slate-800 ut-allowed-content:text-blue-100 ut-label:text-lg ut-allowed-content:ut-uploading:text-red-300"
    content={{
      allowedContent: 'Allowed content',
      button: 'Ready',
    }}
...
export const TWClassName4 = () => (
  <UploadDropzone
    endpoint="mockRoute"
    className="mt-4 bg-slate-800 ut-label:text-lg ut-allowed-content:ut-uploading:text-red-300"
    content={{
      allowedContent: 'Allowed content',
    }}
    // @ts-expect-error - internal prop
