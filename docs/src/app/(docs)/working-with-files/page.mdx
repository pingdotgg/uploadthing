...
[access controls](/concepts/regions-acl#access-controls), you will need to request a
short-lived presigned URL from the API to access the file. You can request one
using [`UTApi.getSignedUrl`](/api-reference/ut-api#get-signed-url), or from the
