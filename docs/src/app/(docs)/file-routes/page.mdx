...
- [Effect/Schema >=3.10](https://effect.website/docs/schema/introduction) is partially
  supported as long as the top-level schema is of type `Schema.Schema` and not wrapped
  like `optional<Schema.Schema>`/`optionalWith<Schema.Schema>`
