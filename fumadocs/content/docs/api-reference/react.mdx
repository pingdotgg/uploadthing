...
of the `generateUploadButton` and `generateUploadDropzone` functions to improve
tree-shaking.
...
<AutoTypeTable path="mdx-components.tsx" name="UploadButtonProps" />

Config object

<AutoTypeTable path="mdx-components.tsx" name="UploadThingComponentConfig" />
...
<AutoTypeTable path="mdx-components.tsx" name="GenerateTypedHelpersOptions" />
...
<Accordions type="single">
  <Accordion title="Several features have been removed:">
