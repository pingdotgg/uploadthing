...
declare const UploadButton: new <TEndpoint extends keyof UploadRouter, TSkipPolling extends boolean = false>(props: {
    config: import("@uploadthing/vue").UploadButtonProps<UploadRouter, TEndpoint, TSkipPolling>;
