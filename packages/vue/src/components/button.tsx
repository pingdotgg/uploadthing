        ...
        (props: { config: UploadButtonProps<TRouter, TEndpoint> }) => {
            ...
            const labelClass = computed(() =>
                twMerge(
                    ...
                    state.value === "uploading" &&
                    `bg-blue-400 after:absolute after:left-0 after:h-full after:bg-blue-600 after:content-[''] ${progressHeights[uploadProgress.value]}`,
            ...
            const allowedContentClass = computed(() => twMerge(
                ...
                styleFieldToClassName($props.appearance?.allowedContent, styleFieldArg.value),
            ))

            const containerStyle = computed(() => styleFieldToCssObject($props.appearance?.container, styleFieldArg.value))
            const labelStyle = computed(() => styleFieldToCssObject($props.appearance?.button, styleFieldArg.value))
            const allowedContentStyle = computed(() => styleFieldToCssObject($props.appearance?.allowedContent, styleFieldArg.value))
